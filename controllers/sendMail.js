import pool from '/config/dbSend.js';
import transporter from '/config/dbMail.js';
...
async function agendarCita(rut, nombre, especialidad, medico, fecha, correo) {
    ...
    try {
        ...
        // Insertar correo en cola de correo
        ...
        await client.query('ROLLBACK');// aborta transacción
        console.error('Error en la transacción: ', error);
    } finally {
        client.release();// libera recursos
    }
}
